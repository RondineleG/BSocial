describe.skip('Cadasrar', function() {
  
    beforeEach(function() {
        cy.login();
    })

it('Cadastrar Dados básicos',function()
{
    ...
    cy.url().should('contains', 'https://app.bussolasocial.com.br/projeto-novo/6576/cadastro/resumo');
    
});

   it('Cadastrar projeto', function() {
    ...
    it.skip('Cadastrar resumo do projeto', function() {
    ...
    it.skip('Cadastrar objetivos', function() {
    ...
    it.skip('Cadastro de planos', function() {

        cy.visit('https://app.bussolasocial.com.br/projeto-novo/6576/cadastro/planos')
    ...
    it.skip('Cadastro de justificativa', function() {      
       
             
       cy.visit('https://app.bussolasocial.com.br/projeto-novo/6576/cadastro/justificativa')
